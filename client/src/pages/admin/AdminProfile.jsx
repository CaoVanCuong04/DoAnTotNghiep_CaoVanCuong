...
import { Typography, Card, Form, Input, Button, message, Upload, Avatar, Divider, Tabs, Row, Col, Space } from 'antd';
import {
    UserOutlined,
    SaveOutlined,
    LockOutlined,
                ...
                <div style={{ paddingTop: 8 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 32 }}>
                        ...
                        <div>
                            ...
                            <br />
                            <Text style={{ fontSize: 11, color: '#7c3aed', fontWeight: 600 }}>QUẢN TRỊ VIÊN</Text>
                        </div>
                    </div>
    ...
    return (
        <div style={{ maxWidth: 800, margin: '0 auto', paddingBottom: 40 }}>
            <div style={{ marginBottom: 24 }}>
                ...
                <Text type="secondary">Quản lý thông tin tài khoản Admin của bạn.</Text>
            </div>
